...
test("homepage renders the approved proposition and evidence hierarchy", async () => {
  ...
  assert.match(html, /property="og:image" content="https:\/\/blutech\.io\/og-blutech-v3\.jpg"/);
  assert.match(html, /property="og:image:width" content="1200"/);
  assert.match(html, /property="og:image:height" content="630"/);
  assert.match(html, /property="og:image:type" content="image\/jpeg"/);
  assert.match(html, /name="twitter:card" content="summary_large_image"/);
  assert.match(html, /name="twitter:image" content="https:\/\/blutech\.io\/og-blutech-v3\.jpg"/);
});
