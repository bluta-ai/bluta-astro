...
check(24,'Multilingual',exists('dist','zh-hk','index.html')&&exists('dist','zh-cn','index.html')&&exists('dist','ar','index.html')&&exists('dist','zh-hk','products','bt102-smart-info-station','index.html')&&exists('dist','ar','projects','three-garden-road','index.html')&&exists('dist','zh-cn','solutions','smart-washroom','index.html')&&exists('dist','ar','resources','smart-washroom-system-design','index.html')&&distText('ar/index.html').includes('dir="rtl"'),'English, Traditional Chinese, Simplified Chinese and Arabic core, product, project, solution and resource routes build with RTL.');
