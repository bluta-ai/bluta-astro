...
const copy = {
  ...
  es: {
    nav: ["Soluciones", "Software", "Proyectos", "Productos"],
    contact: "Contacto",
    eyebrow: "IA FÍSICA PARA EDIFICIOS",
    title: <>Inteligencia,<br /><em>integrada en el edificio.</em></>,
    intro: "Blutech combina sensores precisos, inteligencia en el edge, hardware conectado y software para edificios para convertir las condiciones en tiempo real en espacios más seguros, operaciones más eficientes y activos con mejor rendimiento.",
    explore: "Descubra Blutech",
    work: "Ver proyectos seleccionados",
    trusted: "Probado en edificios complejos y en funcionamiento",
    stats: [["Desde 2019", "inteligencia para edificios desarrollada en Hong Kong"], ["100+", "proyectos reales"], ["200.000+", "dispositivos conectados a Blutech Core"], ["Premiado", "Múltiples premios internacionales y de Hong Kong · iF 2024 · HKICT · APICTA"]],
    valueKicker: "Un edificio mejor es un resultado, no un dispositivo.",
    valueTitle: <>Haga que cada metro cuadrado<br />rinda más.</>,
    valueIntro: "Diseñado para propietarios, equipos de gestión y equipos de proyecto, Blutech reduce la distancia entre la intención del diseño y el rendimiento diario.",
    values: [
      ["01", "Proteger el valor del activo", "Detecte desperdicios, fallos y espacios infrautilizados antes de que resulten costosos. Ofrezca a la dirección una visión fiable de cada inmueble o de toda la cartera."],
      ["02", "Operar con mayor eficiencia", "Automatice inspecciones rutinarias, alertas, informes y órdenes de trabajo. Permita que los equipos se concentren en las decisiones que requieren criterio humano."],
      ["03", "Mejorar la experiencia de los ocupantes", "Responda a las condiciones reales de ocupación, confort y seguridad, sin cámaras en los espacios sensibles."],
      ["04", "Mantener la libertad de diseño", "Sensores discretos, protocolos abiertos y modelos de implantación flexibles se integran tanto en proyectos nuevos como en edificios existentes."],
    ],
    bridgeKicker: "Del plano a la operación diaria",
    bridgeTitle: "Para propietarios. Para operadores.",
    ownerTitle: "Para propietarios",
    ownerText: "Convierta el rendimiento del edificio en decisiones más claras sobre los activos. Controle costes operativos, riesgos, confort y resultados de la cartera desde una capa de inteligencia fiable.",
    ownerList: ["Menor OPEX", "Protección del activo", "Datos ESG verificables", "Visibilidad de la cartera"],
    architectTitle: "Para operadores",
    architectText: "Vea qué requiere atención y pase directamente de la señal a la acción. El estado, las alarmas, los flujos de trabajo, la salud de los dispositivos y los informes se mantienen claros cada día.",
    architectList: ["Estado en tiempo real", "Respuesta más rápida", "Flujos y alertas", "Estado de los dispositivos"],
    systemKicker: "UN SISTEMA · DEL ESPACIO AL SOFTWARE",
    systemTitle: "Detectar. Entender. Actuar.",
    systemIntro: "Blutech transforma datos fragmentados del edificio en un ciclo operativo continuo: desde lo que ocurre en el espacio hasta la siguiente acción del equipo o del sistema.",
    layers: [["01", "Espacio", "Personas, aire, agua, energía y estado de los equipos"], ["02", "Señal", "Sensores que protegen la privacidad y sistemas BMS e IoT existentes"], ["03", "Inteligencia", "IA en el edge, contexto histórico, reglas y razonamiento verificable"], ["04", "Acción", "Control, alertas, órdenes de trabajo, informes y optimización"]],
    dashboardLabel: "BLUTECH HALO · OPERACIONES",
    dashboardTitle: "Halo hace que el edificio sea comprensible.",
    dashboardText: "El estado en tiempo real, los planos, la visualización, las alarmas, el historial, los informes y los controles autorizados se presentan con claridad en ordenador y móvil.",
    platformLabel: "BLUTECH CORE · INFRAESTRUCTURA",
    platformTitle: "Core mantiene la complejidad bajo control.",
    platformText: "El aprovisionamiento, las gateways, la salud de los dispositivos, el mapeo de datos, las reglas, los payloads y las integraciones permanecen en la capa técnica, separados de la operación diaria.",
    deployment: "Nube · Nube privada · Instalación local",
    projectsKicker: "PROYECTOS SELECCIONADOS",
    projectsTitle: "Probado donde el rendimiento importa.",
    projectsIntro: "Implantaciones activas en oficinas de categoría A, aviación, servicios públicos, sanidad y retail muestran cómo una misma capa de inteligencia se adapta a requisitos muy diferentes.",
    projects: [
      ["Three Garden Road", "OFICINAS DE CATEGORÍA A · CENTRAL", "Más de 1.000 dispositivos conectados respaldan baños inteligentes, detección de fugas, calidad del aire interior, coordinación HVAC según ocupación e integración de informes ESG.", ["1.000+ dispositivos conectados", "Coordinación HVAC activa", "Integración de informes ESG"]],
      ["Aeropuerto Internacional de Hong Kong", "AVIACIÓN · HONG KONG", "La monitorización de seguridad de pasajeros en todo el aeropuerto combina sensores Heatmap, visualización de planos, alertas e informes sin cámaras convencionales en espacios sensibles.", ["Cobertura en todo el aeropuerto", "Visualización de planos", "Alertas e informes"]],
      ["Sede de EMSD", "ADMINISTRACIÓN PÚBLICA · KOWLOON BAY", "Una implantación integral de baños inteligentes conecta 230 cabinas desde B1 hasta 6/F con visibilidad de ocupación e integración GWIN.", ["230 cabinas conectadas", "Cobertura B1–6/F", "Integración GWIN"]],
    ],
    productsKicker: "HARDWARE BLUTECH",
    productsTitle: "Señales en las que puede confiar.",
    productsIntro: "Sensores e interfaces diseñados específicamente para captar lo que los sistemas convencionales no ven, con discreción y sin recoger datos personales innecesarios.",
    products: [
      ["HeatMap Pro", "BT337 · DETECCIÓN TÉRMICA PRECISA", "Sensor de matriz térmica 16×12 para obtener información precisa sobre ocupación y espacio sin imágenes de cámaras convencionales.", "Matriz térmica · Ocupación · Flujos del edificio"],
      ["Sensor de calidad del aire interior", "BT306 · AMBIENTAL", "Medición conectada de temperatura, humedad y PM2.5, con parámetros adicionales disponibles según el proyecto.", "Datos ambientales · Tendencias · Interacción BMS"],
      ["Smart Info Station", "BT102 · PANTALLA E INTERFAZ", "Estación informativa Android de gran formato que reúne datos del edificio y del IoT de distintas plantas e instalaciones.", "Android · Datos del edificio · Blutech Halo"],
      ["Smart Signage", "BT101 · PANTALLA E INTERFAZ", "Señalización conectada y compacta para mostrar información en tiempo real en el punto de uso.", "Bluetooth o Android · Datos del edificio"],
    ],
    integrationKicker: "ABIERTO POR DISEÑO",
    integrationTitle: "Conserve lo que funciona. Conecte lo que importa.",
    integrationText: "Blutech trabaja con sistemas antiguos y modernos, por lo que modernizar un edificio inteligente no exige sustituirlo todo.",
    privacyTitle: "La privacidad forma parte de la arquitectura.",
    privacyText: "Las matrices térmicas, mmWave y la IA en el edge generan señales útiles de actividad sin imágenes faciales ni identificadores personales.",
    contactKicker: "EMPIECE CON UN RESULTADO SIGNIFICATIVO",
    contactTitle: "Haga que el próximo edificio funcione tan bien como se ve.",
    contactText: "Comparta el tipo de inmueble, sus sistemas y prioridades. Propondremos un piloto práctico, una ruta de integración y un plan de medición.",
    email: "Escriba a nuestro equipo de proyectos",
    footerLine: "IA e IoT para edificios más seguros, eficientes y con mejor rendimiento.",
  },
};
...
const utilityCopy = {
  ...
  es: { liveLabel:"BLUTECH CORE · CARTERA EN TIEMPO REAL", liveTitle:"Operaciones conectadas del edificio", connected:"Dispositivos conectados", hvac:"Integraciones de sistemas", esg:"Servicios de datos", live:"Activo", included:"Listo", confirmed:"Capacidad a nivel de cartera", scroll:"Desplazar", exploreSoftware:"Descubra Halo y Core", allProjects:"Ver todos los proyectos", catalogue:"Ver el catálogo completo", integration:"Arquitectura de integración", privacyLabel:"Privacidad desde el diseño", noCamera:"Sin cámaras", noFace:"Sin imágenes faciales", edgeAI:"IA en el edge", liveUi:"EN VIVO", alertsUi:"ALERTAS", reportsUi:"INFORMES", portfolio:"Resumen de cartera", building:"Edificio", actions:"Acciones", reporting:"Informes", assigned:"Asignadas", ready:"Listo" },
};
