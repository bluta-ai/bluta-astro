      ...
      <section className="contact-page">
        <div className="contact-lead">
          <p className="eyebrow light">
            <Localized en="CONTACT BLUTECH" tc="聯絡 BLUTECH" sc="联系 BLUTECH" ar="تواصل مع BLUTECH" es="CONTACTE CON BLUTECH" />
          </p>
          <h1>
            <Localized
          ...
          <p>
            <Localized
              ...
              es="Tanto si tiene un problema en un edificio, una pregunta sobre un producto o un posible proyecto, nuestro equipo está preparado para ayudarle."
            />
          </p>
        </div>
        <div className="contact-card">
          <span>
            <Localized en="CONTACT" tc="聯絡方式" sc="联系方式" ar="بيانات الاتصال" es="CONTACTO" />
          </span>
        ...
        <div className="catalogue-heading">
          <div>
            <p className="section-label">
              <Localized en="CONTACT US" tc="聯絡我們" sc="联系我们" ar="تواصل معنا" es="CONTACTO" />
            </p>
            <h2>
              <Localized en="A simple enquiry." tc="簡單告訴我們。" sc="简单告诉我们。" ar="استفسار بسيط." es="Una consulta sencilla." />
            </h2>
          </div>
          <p>
            <Localized
              ...
              es="Deje su nombre, empresa, correo electrónico o teléfono y un mensaje breve. Nuestro equipo se pondrá en contacto con usted."
            />
          </p>
        </div>
        <ContactForm />
      ...
      <section className="contact-route">
        <p>
          <Localized
            ...
            es="Para solicitar especificaciones o documentación para consultores, indique el modelo de producto correspondiente en su mensaje."
          />
        </p>
      </section>
      <SiteFooter />
